...
float hasilun[100];
char opsisatu, jawabansatu, jawabandua, jawabantiga, jawabanempat, jawabanlima, opsizzzzz;
...
opsidua:
            ...
            do
            {
                cout << "Apakah Anda Ingin Kembali Ke Halaman Utama? (y/Y) :";
                cin >> opsizzzzz;
            }
            while((opsizzzzz=='n') || (opsizzzzz=='n'));
            opsizzzzz = 'n';
            system("cls");
            goto homepage;
        }
